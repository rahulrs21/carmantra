export default function AboutPage() {
  return (
    <section className="relative pt-40 min-h-screen bg-gray-50 dark:bg-gray-900 py-16 px-6 md:px-12 lg:px-24 transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 gap-10">
